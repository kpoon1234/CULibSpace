    ...
    <div className="rounded-xl border border-gray-200 bg-paper p-5 shadow-sm">
      ...
      <div className="mt-5 space-y-2">
        <button
          ...
          className="w-full rounded-md bg-rose-600 px-3 py-2 text-sm font-medium text-white transition-colors hover:bg-rose-700 disabled:cursor-not-allowed disabled:opacity-50"
        >
          Reserve this table
        </button>
